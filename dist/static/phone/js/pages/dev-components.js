...
var Mask = __webpack_require__(5); // 遮罩
...
window.addEventListener('load', function () {
    setTimeout(function () {
        ...
        // 没有数据
        (function () {
            var NoData = __webpack_require__(16);
