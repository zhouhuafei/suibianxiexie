...
"use strict";
var getDomArray=__webpack_require__(2),typeOf=__webpack_require__(24);function isDomParent(r,e){var t=getDomArray(r)[0],o=getDomArray(e)[0];if(!t||!o)return console.log("参数错误"),!1;if("string"===typeOf(e))return null!==t.querySelector(e);for(var n=o;n!==t&&null!==n;)n=n.parentNode;return n===t}module.exports=isDomParent;
