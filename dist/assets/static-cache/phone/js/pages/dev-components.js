...
var tools = __webpack_require__(0); // 工具方法集合
var applications = __webpack_require__(1); // 应用方法集合
var Super = __webpack_require__(60); // 超类型(子类型继承的对象)
...
var Sub = function (_Super) {
    ...
    _createClass(Sub, [{
        ...
        value: function power() {
            ...
            (function () {
                var Loading = __webpack_require__(131);
            ...
            // 分页测试
            (function () {
                var Pagination = __webpack_require__(132);
                new Pagination({ wrap: '.page-pagination' });
            })();

            // 没有数据
            (function () {
                var NoData = __webpack_require__(133);
            ...
            (function () {
                ...
                var SuperEs6 = __webpack_require__(60);
                new SuperEs6({ wrap: '.page-super-type' });
                var SubEs6 = __webpack_require__(135);
                new SubEs6({ wrap: '.page-super-type' });
            })();

            // 单选开关
            (function () {
                var Radio = __webpack_require__(136);
                new Radio({
            ...
            // 表格
            (function () {
                var Table = __webpack_require__(137);
                new Table({
                    wrap: '.page-table',
                    data: {
                        header: [{
            ...
            (function () {
                __webpack_require__.e/* require.ensure */(1).then((function (require) {
                    var Star = __webpack_require__(171);
                    new Star({
                        wrap: '.page-star',
                        callback: {
                            click: function click(json) {
