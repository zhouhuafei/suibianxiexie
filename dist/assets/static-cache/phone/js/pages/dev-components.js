...
var tools = __webpack_require__(0); // 工具方法集合
var applications = __webpack_require__(1); // 应用方法集合
var Super = __webpack_require__(58); // 超类型(子类型继承的对象)
...
var Sub = function (_Super) {
    ...
    _createClass(Sub, [{
        ...
        value: function power() {
            ...
            (function () {
                var Loading = __webpack_require__(128);
            ...
            // 分页测试
            (function () {
                var Pagination = __webpack_require__(129);
                new Pagination({ wrap: '.page-pagination' });
            })();

            // 没有数据
            (function () {
                var NoData = __webpack_require__(130);
            ...
            // 表格
            (function () {
                var Table = __webpack_require__(134);
                new Table({
                    wrap: '.page-table',
                    data: {
                        header: [{
            ...
            (function () {
                __webpack_require__.e/* require.ensure */(1).then((function (require) {
                    var Star = __webpack_require__(166);
                    new Star({
                        wrap: '.page-star',
                        callback: {
                            click: function click(json) {
