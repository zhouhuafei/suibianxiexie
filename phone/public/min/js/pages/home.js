...
(function e(t, n, r) {
    function s(o, u) {
    ...
    }, { "../commons/common": 2, "../modules/m-navigation": 11, "../modules/m-slide": 12 }], 2: [function (require, module, exports) {
        //版权
        (function () {
    ...
    }, { "../function/obj-remove-quote": 6, "../tools/extend": 15 }], 4: [function (require, module, exports) {
        //创建元素节点
    ...
    }, { "../function/constructor-inherit": 3, "../function/create-element": 4, "../modules/m-super-type": 13 }], 9: [function (require, module, exports) {
        var createElement = require('../function/create-element'); //创建元素节点
        var constructorInherit = require('../function/constructor-inherit'); //构造函数的继承(拷贝继承)
        var SuperType = require('../modules/m-super-type'); //超类型(子类型继承的对象)
        ...
        module.exports = SubType;
    }, { "../function/constructor-inherit": 3, "../function/create-element": 4, "../modules/m-super-type": 13 }], 10: [function (require, module, exports) {
        var extend = require('../tools/extend'); //对象的扩展方法
    ...
    }, { "../function/get-dom-array": 5, "../function/offset": 7, "../tools/extend": 15 }], 11: [function (require, module, exports) {
        var createElement = require('../function/create-element'); //创建元素节点
        var constructorInherit = require('../function/constructor-inherit'); //构造函数的继承(拷贝继承)
        var SuperType = require('../modules/m-super-type'); //超类型(子类型继承的对象)
        ...
        module.exports = SubType;
    }, { "../function/constructor-inherit": 3, "../function/create-element": 4, "../modules/m-super-type": 13 }], 12: [function (require, module, exports) {
        var createElement = require('../function/create-element'); //创建元素节点
        var constructorInherit = require('../function/constructor-inherit'); //构造函数的继承(拷贝继承)
        ...
        module.exports = SubType;
    }, { "../function/constructor-inherit": 3, "../function/create-element": 4, "../modules/m-super-type": 13, "../plugs/touch-slide": 14 }], 13: [function (require, module, exports) {
        var extend = require('../tools/extend'); //对象的扩展方法
        var createElement = require('../function/create-element'); //创建元素节点
        var getDomArray = require('../function/get-dom-array'); //获取原生的dom节点并转换成数组
    ...
    }, { "../function/create-element": 4, "../function/get-dom-array": 5, "../tools/extend": 15 }], 14: [function (require, module, exports) {
        /*!
         * TouchSlide v1.1
