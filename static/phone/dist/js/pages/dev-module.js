...
window.addEventListener('load', function () {
    setTimeout(function () {
        ...
        //ajax测试
        (function () {
            var Ajax = __webpack_require__(39);
            // new Ajax({
            //     callback: {},
            //     config: {
            //         url: '/api/getList'
        ...
        //base函数测试
        (function () {
            var WhenScrollBottom = __webpack_require__(40);
            //测试滚动到底部loading
        ...
        (function () {
            ...
            var SubType = __webpack_require__(42);
            ...
            var SubTypeEs6 = __webpack_require__(43);
            new SubTypeEs6({ wrap: '.page-super-type' });
        })();

        //返回顶部
        (function () {
            var GoTop = __webpack_require__(44);
            new GoTop();
        })();
        ...
        //表格
        (function () {
            var Table = __webpack_require__(47);
            var table = new Table({
                wrap: '.page-table',
                data: {
                    header: [{
        ...
        //星评
        (function () {
            var Star = __webpack_require__(48);
            var star = new Star({
                wrap: '.page-star',
                callback: {
                    click: function click(json) {
...
var createElement = __webpack_require__(0); //创建元素节点
var constructorInherit = __webpack_require__(2); //构造函数的继承(拷贝继承)
var scrollTo = __webpack_require__(45); //滚动到指定位置
var SuperType = __webpack_require__(1); //超类型(子类型继承的对象)
