...
window.addEventListener('load', function () {
    setTimeout(function () {
        ...
        //base函数测试
        (function () {
            var WhenScrollBottom = __webpack_require__(38);
            //测试滚动到底部loading
        ...
        (function () {
            ...
            var SubType = __webpack_require__(40);
            ...
            var SubTypeEs6 = __webpack_require__(41);
            new SubTypeEs6({ wrap: '.page-super-type' });
        })();

        //返回顶部
        (function () {
            var GoTop = __webpack_require__(42);
            new GoTop();
        })();
        ...
        //单选开关
        (function () {
            var Radio = __webpack_require__(44);
            new Radio({
...
var createElement = __webpack_require__(0); //创建元素节点
var constructorInherit = __webpack_require__(2); //构造函数的继承(拷贝继承)
var scrollTo = __webpack_require__(43); //滚动到指定位置
var SuperType = __webpack_require__(1); //超类型(子类型继承的对象)
