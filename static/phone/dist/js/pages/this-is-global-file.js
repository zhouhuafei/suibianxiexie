...
var extend = __webpack_require__(5); //对象的扩展方法
var objRemoveQuote = __webpack_require__(20); //对象移除引用
...
module.exports.Vue = _vue2.default; //全局的样式
...
//延迟加载
(function () {
    var LazyLoad = __webpack_require__(24);
    new LazyLoad();
})();
...
var constructorInherit = __webpack_require__(2); //构造函数的继承(拷贝继承)
var SuperType = __webpack_require__(1); //超类型(子类型继承的对象)
var jsonToArray = __webpack_require__(23);
...
var extend = __webpack_require__(5); //对象的扩展方法
var offset = __webpack_require__(25); //获取元素距离文档的left和top
var getDomArray = __webpack_require__(6); //获取原生的dom节点并转换成数组
