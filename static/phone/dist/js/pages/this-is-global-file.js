...
/******/ 		}
/******/ 		script.src = __webpack_require__.p + "js/chunk/" + ({"0":"m-dialog","1":"dev-module","2":"home","3":"dev-global","4":"500","5":"404","6":"sample","7":"register","8":"mine","9":"login","10":"dev-word","11":"dev-list"}[chunkId]||chunkId) + "." + chunkId + ".chunk.js";
...
var extend = __webpack_require__(5); //对象的扩展方法
var objRemoveQuote = __webpack_require__(22); //对象移除引用
...
//全局的样式
module.exports.Vue = _vue2.default; //vue框架
...
//延迟加载
(function () {
    var LazyLoad = __webpack_require__(26);
    new LazyLoad();
})();
...
var constructorInherit = __webpack_require__(2); //构造函数的继承(拷贝继承)
var SuperType = __webpack_require__(1); //超类型(子类型继承的对象)
var jsonToArray = __webpack_require__(25);
...
var extend = __webpack_require__(5); //对象的扩展方法
var offset = __webpack_require__(27); //获取元素距离文档的left和top
var getDomArray = __webpack_require__(6); //获取原生的dom节点并转换成数组
