...
window.addEventListener('load', function () {
    setTimeout(function () {
        ...
        //返回顶部
        (function () {
            var GoTop = __webpack_require__(39);
            new GoTop();
        })();
        ...
        //单选开关
        (function () {
            const Radio = __webpack_require__(41);
            new Radio({
        ...
        //表格
        (function () {
            const Table = __webpack_require__(42);
        ...
        //星评
        (function () {
            const Star = __webpack_require__(43);
            const star = new Star({
                wrap: `.page-star`,
                callback: {
                    click: function (json) {
...
var createElement = __webpack_require__(0); //创建元素节点
var constructorInherit = __webpack_require__(2); //构造函数的继承(拷贝继承)
var scrollTo = __webpack_require__(40); //滚动到指定位置
var SuperType = __webpack_require__(1); //超类型(子类型继承的对象)
