...
(function e(t, n, r) {
    function s(o, u) {
    ...
    }, { "../modules/m-copyright": 5, "../modules/m-footer-nav": 6, "../modules/m-lazy-load": 7 }], 2: [function (require, module, exports) {
        //创建元素节点
    ...
    }, { "../function/get-dom-array": 3, "../tools/extend": 10 }], 5: [function (require, module, exports) {
    ...
    }, { "../function/create-element": 2, "../modules/m-super-type": 8, "../tools/constructor-inherit": 9 }], 6: [function (require, module, exports) {
        var createElement = require('../function/create-element'); //创建元素节点
        var constructorInherit = require('../tools/constructor-inherit'); //构造函数的继承(拷贝继承)
        var SuperType = require('../modules/m-super-type'); //超类型(子类型继承的对象)
        ...
        module.exports = SubType;
    }, { "../function/create-element": 2, "../modules/m-super-type": 8, "../tools/constructor-inherit": 9, "../tools/json-to-array": 11 }], 7: [function (require, module, exports) {
        var extend = require('../tools/extend'); //对象的扩展方法
    ...
    }, { "../function/get-dom-array": 3, "../function/offset": 4, "../tools/extend": 10 }], 8: [function (require, module, exports) {
        var extend = require('../tools/extend'); //对象的扩展方法
        var createElement = require('../function/create-element'); //创建元素节点
        var getDomArray = require('../function/get-dom-array'); //获取原生的dom节点并转换成数组
    ...
    }, { "../function/create-element": 2, "../function/get-dom-array": 3, "../tools/extend": 10 }], 9: [function (require, module, exports) {
        var extend = require('../tools/extend'); //对象的扩展方法
    ...
    }, { "../tools/extend": 10, "../tools/obj-remove-quote": 12 }], 10: [function (require, module, exports) {
        //对象的扩展方法
