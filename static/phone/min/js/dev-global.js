...
window.addEventListener('load', function () {
    setTimeout(function () {
        ...
        //验证
        (function () {
            const ValidateInput = __webpack_require__(26);
...
var validate = __webpack_require__(27); //表单验证
var getDomArray = __webpack_require__(4); //获取原生的dom节点并转换成数组
