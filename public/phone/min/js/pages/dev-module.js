...
(function e(t, n, r) {
    function s(o, u) {
        ...
        module.exports = SubType;
    }, { "../function/create-element": 3, "../modules/m-super-type": 24, "../tools/constructor-inherit": 28, "../tools/json-to-array": 30 }], 11: [function (require, module, exports) {
        var createElement = require('../function/create-element'); //创建元素节点
        var constructorInherit = require('../tools/constructor-inherit'); //构造函数的继承(拷贝继承)
    ...
    }, { "../tools/extend": 29, "../tools/obj-remove-quote": 31 }], 29: [function (require, module, exports) {
        //对象的扩展方法
